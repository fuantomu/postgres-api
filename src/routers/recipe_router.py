...
class Recipe(Router):
    ...
    def __init__(self):
        ...
        self.router.add_api_route("/RecipeIngredients", self.delete_recipe_ingredients, methods=["DELETE"], status_code=200, summary="Delete one or more ingredient from a recipe", responses={400: {"model": BaseResponseModel}})
